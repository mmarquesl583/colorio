...
export default function ChatPlacar({ players, youId, chat, onSendChat }: Props) {
  ...
  return (
    <>
      <div className="corio-tabbar" style={{ flex: 'none', gap: 4, margin: '8px 16px 0' }}>
      ...
      <div className={`corio-placar-panel${tab === 'placar' ? '' : ' corio-panel-hidden'}`} style={{ flexDirection: 'column' }}>
      ...
      <div className={`corio-chat-panel${tab === 'chat' ? '' : ' corio-panel-hidden'}`} style={{ flexDirection: 'column' }}>
